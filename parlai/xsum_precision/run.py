...
def set_args():
    ...
    out_dir = f"/home/awang/projects/qags/data/mturk/xsum/precision"
    ...
    #args['ok_worker_file'] = f'/home/awang/projects/qags/data/mturk/ok_workers.11201111.txt'
    args['ok_worker_file'] = None
    args['bad_worker_file'] = f'/home/awang/projects/qags/data/mturk/bad_workers.11201111.txt'
    ...
    args['model_comparisons'] = [
                                 ...
                                 (f'src_w_trg_para_nex1000_randorder_shard{shard_n}', f'bart_sent_nex1000_randorder_shard{shard_n}'),
