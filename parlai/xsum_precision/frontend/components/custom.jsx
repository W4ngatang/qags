  ...
  render () {
    ...
    let content = (
      <div>
        ...
        <b>If you correctly complete all tasks, we will award a $0.85 bonus</b>.&nbsp;
        <b>You must spend at least 30 seconds on this HIT and provide text justifications of your decisions.</b>&nbsp;
        <br/><br/>
