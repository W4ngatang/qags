...
def main():
    ...
    if args.do_predict and (not args.distributed or args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        output_prediction_file = os.path.join(args.prediction_file)
        output_nbest_file = None #os.path.join(args.output_dir, "nbest_predictions.json")
        output_null_log_odds_file = None #os.path.join(args.output_dir, "null_odds.json")
